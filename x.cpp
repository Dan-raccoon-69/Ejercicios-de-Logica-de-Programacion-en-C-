...
int main(){
    char contrasenia[20]; 
    int i,j, aux,opc;
    int d=0,wr=0,as=0,b,n,e,es,Datos,a,edad,estatura,peso,IMC;
    d=menup();
while(d>1 | d<3){
...
int menuejer1(){// segundo menu
    int op1=0;
        ...
        cout<<"*                                    *"<<endl;
        cout<<"Programa 1 Cont ";cout<<" Programa2 Orden num"<<endl;  
 ...
 int menuejer2(){
    int op2=0;
        ...
        cout<<"*                                    *"<<endl;
        cout<<"*  Programa 1 Ingresar datos  ";cout<<"    Programa 2 IMC   *"<<endl;  
        cout<<"*                                    *"<<endl;
        cout<<"**"<<endl;
        cout<<" "<<endl;
...
int menuejer3(){
    ...
    while(op3<1 | op3>4){
        ...
        cout<<"*                                    *"<<endl;
        cout<<"*  Programa 1 IVA      ";cout<<"    Programa 2 Checklist   *"<<endl;  
        cout<<"*                                    *"<<endl;
        cout<<"**"<<endl;
        cout<<" "<<endl;
